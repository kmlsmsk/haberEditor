/*     NEWS EDITOR AI v11.1 - CHROME EXTENSION EDITION (SCROLL & LAYOUT FIX)    Core: Ege Ajans Haber Asistanı (Gemini 3 Flash Preview) */  
(function() {     
    // 1. YAPILANDIRMA     
    const CFG = {         
    ...
    style.innerHTML = `         
        ...
        .ne-body {              
            ...
            min-height: 0; /* [KRİTİK DÜZELTME]: İçeriğin flex parent'ı zorlayıp footer'ı taşırmasını engeller */
            overflow-y: auto; /* İçerik uzarsa sadece burası kaydırılır */             
            overflow-x: hidden;             
            background: #ffffff;              
        ...
        .ne-footer {              
            ...
            background: #fafafa;              
            flex-shrink: 0; /* [KRİTİK DÜZELTME]: Asla küçülme veya kaybolma, aşağı itilme yaşama */             
            z-index: 10;             
            position: relative;         
        }         
        ...
        /* Form Elemanları */         
        .ne-label { display: block; font-size: 13px; font-weight: 600; color: #475569; margin-bottom: 8px; flex-shrink:0; }         
        .ne-input { width: 100%; padding: 12px 16px; border: 1px solid #cbd5e1; border-radius: 10px; font-size: 14px; margin-bottom: 20px; font-family: inherit; box-sizing: border-box; transition: 0.2s; outline: none; background: #f8fafc; color: #0f172a; flex-shrink:0;}         
        ...
        .ne-img-area { position: relative; border: 2px dashed #93c5fd; border-radius: 10px; text-align: center; color: #64748b; cursor: pointer; transition: 0.2s; margin-bottom: 10px; background: #eff6ff; box-sizing: border-box; width: 100%; height: 90px; display: flex; flex-direction: column; align-items: center; justify-content: center; overflow: hidden; flex-shrink:0; }         
    ...
    const els = {         
        ...
        bodyContainer: document.getElementById('ne-body-container') // Scroll sıfırlama için eklendi
    };     
    let currentBase64 = '';      
    ...
    const closeModal = () => {         
        ...
        setTimeout(() => {             
            ...
            els.bodyContainer.scrollTop = 0; // Scroll'u başa al         
            removeImage();         
        }, 300);     
    };      
        ...
        chrome.storage.local.get(['geminiNewsKey'], async function(result) {             
            ...
            try {                 
                ...
                setTimeout(() => {                     
                    ...
                    // İşlem bittiğinde metni okuyabilmek için scroll'u kesin olarak yukarı alır
